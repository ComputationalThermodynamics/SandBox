...
scatter!(d,tms*1e6,ma=0.4,mc=:gray,ms=2,xlabel="Norm(ΔΓ)",ylabel="Minimization time [µs]",title=ph.ph,legend=false, label=leg, dpi=300)
...
savefig("tms_vs_normdG_"*ph.ph*".png")
